...
export const ports = [
  {
    ...
    activities: [
      ...
      {
        icon: "🍽",
        name: "Lunch back in Salerno",
        desc: "After Pompeii, the afternoon is yours in Salerno. The waterfront Lungomare is a short walk from the bus drop — good spot for a casual lunch before boarding. No reservations needed, plenty of options along the seafront.",
        tags: ["City", "On foot"],
      },
      {
        icon: "⛪",
